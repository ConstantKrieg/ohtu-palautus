...
public class KauppaTest {
    ...
    @Test
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikeillaParametreillaJosOstetaanKaksiEriTuotetta() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikeillaParametreillaJosOstetaanKaksiEriTuotettaJoistaToinenLoppu() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void uudenAsioinninAloittaminenNollaaOstoskorinTiedot() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
